...
// const spheres = [
//   [1, 'orange', 0.05, [-4, -0, -1]],
//   [0.75, 'hotpink', 0.1, [-4, -0, -2]],
//   [1.25, 'aquamarine', 0.2, [4, -0, 2]],
//   [1.5, 'lightblue', 0.3, [-4, -0, -3]],
//   [2, 'pink', 0.3, [-4, -0, -4]],
//   [2, 'skyblue', 0.3, [-4, -0, -4]],
//   [1.5, 'orange', 0.05, [-4, -0, -1]],
//   [2, 'hotpink', 0.1, [-4, -0, -2]],
//   [1.5, 'aquamarine', 0.2, [4, -0, 2]],
//   [1.25, 'lightblue', 0.3, [-4, -0, -3]],
//   [1, 'pink', 0.3, [-4, 0, -4]],
//   [2  , 'skyblue', 0.3, [-4, 0, -4]]
// ]
const spheres = [
  [1, 'orange', 0.05, [-8, 0, -1]],
  [0.75, 'hotpink', 0.1, [-6.75, 0, -2]],
  [1.25, 'aquamarine', 0.2, [-5.5, 0, 2]],
  [1.5, 'lightblue', 0.3, [-4.25, 0, -3]],
  [2, 'pink', 0.3, [-3, 0, -4]],
  [2, 'skyblue', 0.3, [-1.75, 0, -4]],
  [1.5, 'orange', 0.05, [-0.5, 0, -1]],
  [2, 'hotpink', 0.1, [0.75, 0, -2]],
  [1.5, 'aquamarine', 0.2, [2, 0, 2]],
  [1.25, 'lightblue', 0.3, [3.25, 0, -3]],
  [1, 'pink', 0.3, [4.5, 0, -4]],
  [2, 'skyblue', 0.3, [5, 0, -4]]
]
...
function Sphere({ position, scale = 1, speed = 0.1, color = 'white' }) {
  return (
    ...
    <Float rotationIntensity={2} floatIntensity={20} speed={speed} floatingRange={[-0.01, 0.01]}>
...
function Turtle(props) {
  const { scene, animations } = useGLTF('./assets/model_52a_-_kemps_ridley_sea_turtle_no_id-transformed.glb')
